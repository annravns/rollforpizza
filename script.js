...
function roll(arr) {
    ...
    if (finalPizza.includes(randomElement)) {
        ...
        // if all elements have been added to the array, show an alert
...
//create a new array with the pizza style, sauce, cheese and then push those elements, make the arrays reset everytime the button is clicked
//show results as we click
